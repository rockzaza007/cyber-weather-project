...
export interface ApiClassroomClassroom extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subjects: Attribute.Relation<'api::classroom.classroom', 'manyToMany', 'api::subject.subject'>;
    students: Attribute.Relation<'api::classroom.classroom', 'manyToMany', 'api::student.student'>;
    teachers: Attribute.Relation<'api::classroom.classroom', 'manyToMany', 'api::teacher.teacher'>;
    rooms: Attribute.Relation<'api::classroom.classroom', 'manyToMany', 'api::room.room'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::classroom.classroom', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::classroom.classroom', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subjects: Attribute.Relation<'api::room.room', 'manyToMany', 'api::subject.subject'>;
    classrooms: Attribute.Relation<'api::room.room', 'manyToMany', 'api::classroom.classroom'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::student.student', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::student.student', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiSubjectSubject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    teacher: Attribute.Relation<'api::subject.subject', 'manyToOne', 'api::teacher.teacher'>;
    student: Attribute.Relation<'api::subject.subject', 'manyToOne', 'api::student.student'>;
    rooms: Attribute.Relation<'api::subject.subject', 'manyToMany', 'api::room.room'>;
    classrooms: Attribute.Relation<
      'api::subject.subject',
      'manyToMany',
      'api::classroom.classroom'
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::subject.subject', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::subject.subject', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiTeacherTeacher extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::teacher.teacher', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::teacher.teacher', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiWeatherAuthorizationWeatherAuthorization extends Schema.CollectionType {
  collectionName: 'weather_authorizations';
  info: {
    singularName: 'weather-authorization';
    pluralName: 'weather-authorizations';
    displayName: 'weather-authorization';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::weather-authorization.weather-authorization',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::weather-authorization.weather-authorization': ApiWeatherAuthorizationWeatherAuthorization;
    }
  }
}
